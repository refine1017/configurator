<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.project_id" @change="handleFilter">
...
<script>
import { fetchList, createRow, updateRow, deleteRow, copyRow } from '@/api/environment'
    ...
    copyData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.listLoading = true
          const tempData = Object.assign({}, this.temp)
          copyRow(this.tempId, tempData).then(() => {
            this.listLoading = false
            this.dialogFormVisible = false
            this.render()
            this.$notify({
